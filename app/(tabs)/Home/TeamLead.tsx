  ...
  useEffect(() => {
    const fetchVolunteers = async () => {
      try {
        ...
        console.error("Error in volunteer fetch:", err);
      } finally {
              ...
              <View style={{ paddingHorizontal: 16 }}>
                {volunteers.length === 0 ? (
                  <View style={{
                    ...
                    >
                      No volunteers found in your church
                    </Text>
                  </View>
                ) : (
                  <View style={{ gap: 12 }}>
                    {volunteers.map((volunteer) => (
                      <TouchableOpacity
                        ...
                        onPress={() => router.push(`/Chat/${volunteer.id}`)}
                        activeOpacity={0.7}
                      >
                        <Image
                          source={{
                        ...
                        <View style={{ flex: 1, marginLeft: 12 }}>
                          ...
                          >
                            Member since{" "}
                            {moment(volunteer.created_at).format("MMM YYYY")}
                          </Text>
                        </View>
                        <Ionicons
            ...
            <View>
              ...
              >
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  ...
                  <Text
                    style={{ marginLeft: 4, color: "#9ca3af", fontSize: 12 }}
                  >
                ...
                <View style={{ flexDirection: "row", marginTop: 8 }}>
                  {group.memberImages.slice(0, 3).map((image, index) => (
                    <Image
                      key={index}
                      source={{
                        uri: image || "https://via.placeholder.com/30",
                      }}
                      style={{
                        width: 24,
                        height: 24,
